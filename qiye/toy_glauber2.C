...
void collide(vector<Nucleon>& A_nuc,
             vector<Nucleon>& B_nuc)
{
...
void toy_glauber2() {
    ...
    TH2D *hXY_part = new TH2D("hXY_part","participants;x;y",
                             200,-15,15,200,-15,15);

    TH2D *hXY_hadron = new TH2D("hXY_hadron",
                               "hadron XY;x;y",
                               200,-15,15,200,-15,15);

    TH2D *hPxPy = new TH2D("hPxPy",
                          "px-py;px;py",
                          200,-2,2,200,-2,2);
