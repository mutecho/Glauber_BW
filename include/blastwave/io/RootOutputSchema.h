...
namespace blastwave::io {
  ...
  inline constexpr char kV2WrtPsi2VsEps3HistogramName[] = "v2_wrt_psi2_vs_eps3";
  inline constexpr char kCentralityHistogramName[] = "cent";
  inline constexpr char kParticipantXYHistogramName[] = "participant_x-y";
  inline constexpr char kInitialGeometryDensityHistogramName[] = "initial_geometry_density_x-y";
  ...
  struct EventBranches {
    ...
    Int_t initialGeometryMode = 0;
    Double_t eps3 = 0.0;
    Double_t psi3 = 0.0;
    Double_t v3 = 0.0;
    Double_t v2WrtPsi2 = 0.0;
    Double_t v3WrtPsi3 = 0.0;
    Double_t xCenterInit = 0.0;
    Double_t yCenterInit = 0.0;
